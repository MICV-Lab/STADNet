...
# model name
parser.add_argument('--experiment_name', type=str, default='sr_4x_result', help='give a experiment name before training')
parser.add_argument('--model_type', type=str, default='McMRSR', help='model type')
parser.add_argument('--resume', type=str, default='./outputs/sr_4x/checkpoints/model_669.pt', help='Filename of the checkpoint to resume')
