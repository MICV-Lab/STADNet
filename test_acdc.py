...
# model name
parser.add_argument('--experiment_name', type=str, default='sr_4x_new_result', help='give a experiment name before training')
parser.add_argument('--model_type', type=str, default='McMRSR', help='model type')
parser.add_argument('--resume', type=str, default='./outputs/sr_4x_new/checkpoints/model_99.pt', help='Filename of the checkpoint to resume')
...
sio.savemat(os.path.join(image_directory, 'test_eval_99.mat'), model.results)
