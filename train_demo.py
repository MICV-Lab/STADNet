...
# model name
parser.add_argument('--experiment_name', type=str, default='sr_4x', help='give a experiment name before training')
...
# dataset
parser.add_argument('--data_root', type=str, default='./mana_swin_slide/slide_data', help='data root folder')
parser.add_argument('--list_dir', type=str, default='./mana_swin_slide/slide_data_list', help='data list_dir root folder')
...
parser.add_argument('--gpu_ids', type=int, default=[0], help='list of gpu ids') # [5]
